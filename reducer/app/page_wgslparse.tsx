...
// 12-10-24
// darth shader uses naga for ir and tree-sitter for parsing shaders into asts
// paper has interesting points about using both
// generates both, but uses C code-- needs to be compiled to webassembly

// for now, let's see how cody jason's works
// npm install shaderkit
// has direct code for parsing GLSL into AST, but WGSL is wip apparently

// nvm going back to darthshader

// from parsing-in-javascript site-- 
// antlr (no wgsl grammar)

// found wasm file (allows u to run non js code on web)
// https://github.com/gpuweb/tree-sitter-wgsl/tree/main

// try to generate wasm file from the grammer subrepo in webgpu repo

// how to convert tree back to shader

'use client'
import WgslParser from '../components/wgsl_parser';
...
//             </button>
//             <div style={styles.output}>
//               <h2 style={styles.subTitle}>Mismatches</h2>
...
//   },
//   wideButton: {
//     width: 'calc(100% - 40px)', // Matches width of shader columns
//   },
//   output: {
//     marginTop: '20px',
//     backgroundColor: '#f0f0f0',
